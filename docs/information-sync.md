...
| Player set | Named Player IDs and god view               | role assignment, alignment or exact-role inspection result, potion use, regular attack target for living Wolves and a Witch with antidote, delivery state |
