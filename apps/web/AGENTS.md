...
- Role-effect IDs are open plugin identifiers. The asset presentation registry supplies their
  semantic icon, timing, label, role, and ability metadata; Web components consume that registry
  without role-event switches.
